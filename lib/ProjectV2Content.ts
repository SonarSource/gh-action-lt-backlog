...
/**
   ...
   * @returns
   */
export async function getIssueOrPrV2(
 ...
 * @param isOrg
 */
export async function moveOrCreateCardV2(issueOrPR: IssueOrPR, columnId: string, repoOwner: string, projectNumber: number, isOrg: boolean): Promise<void> {
 ...
 */
export async function createCardV2(issueOrPr: IssueOrPR, projectId: string): Promise<string> {
 ...
 * @returns
 */
export async function getProjectDataV2(owner: string, projectNumber: number, isOrg: boolean) {
...
export async function removeAssigneesV2(issueOrPr: IssueOrPR, oldUserIds: string[]): Promise<void> {
  const query = {
    query: `
...
/**
  ...
  * @param oldUserIds
  */
export async function reassignIssueV2(issueOrPr: IssueOrPR, newUserId: string, oldUserIds: string[]) {
  const query = {
    query: `
