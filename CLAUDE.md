...
```bash
sonar analyze agentic --project SonarSource_gh-action-lt-backlog --depth DEEP --file <path/to/file1> --file <path/to/file2>
```
...
```bash
sonar analyze agentic --project SonarSource_gh-action-lt-backlog --depth DEEP
```
