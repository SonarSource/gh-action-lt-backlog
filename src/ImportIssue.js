 ...
 */
import { AtlassianDocument } from './helpers/AtlassianDocumentFormat.js';
import { JIRA_DOMAIN } from './helpers/Constants.js';
...
export class ImportIssue extends OctokitAction {
  ...
  async importIssue(jiraProject, issue) {
    ...
    promises.push(
      ...
      this.updateIssueTitle(issue.number, `${id} ${issue.title}`),
    );
...
runAction(import.meta.url, ImportIssue);
