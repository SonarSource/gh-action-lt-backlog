...
export class LockBranchAction extends OctokitAction {
    ...
    async buildSlackMessage(pattern, lockBranch) {
        ...
        return `*${this.repo.repo}*: The branch \`${pattern}\` was ${action} by <${this.payload.sender.html_url}|${this.payload.sender.login}>${suffix}`;
    }
...
//# sourceMappingURL=LockBranchAction.js.map