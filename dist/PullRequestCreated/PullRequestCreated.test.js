...
describe('PullRequestCreated', () => {
    ...
    it('Standalone PR with USER ticket in title', async () => {
        ...
        expect(logTester.logsParams).toStrictEqual([
            ...
            "No parent issue found",
            "No boardId is configured for team .NET Squad",
            "Invoked jira.createIssue('KEY', 'Reproducer for USER-1234 should ignore issue ID', {\"issuetype\":{\"name\":\"Maintenance\"},\"customfield_10001\":\"dot-neeet-team\",\"customfield_10020\":null})",
