...
exports.GraphQLStub = void 0;
exports.createLockBranchGraphQLStub = createLockBranchGraphQLStub;
class GraphQLStub {
    stubs = [];
    addStub(name, query, response) {
...
exports.GraphQLStub = GraphQLStub;
function createLockBranchGraphQLStub(hasNextPage = false) {
...
//# sourceMappingURL=GraphQLStub.js.map