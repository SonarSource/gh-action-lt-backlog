...
const UnlockBranch_1 = require("./UnlockBranch");
...
function sendGraphQLStub(query) {
    const graphQL = [
        ...
        {
            name: 'updateBranchProtectionRule to unlock id-of-unlocked-3',
            query: `
        mutation {
          ...
          })
          {
            ...
            response: {
                updateBranchProtectionRule: {
                    branchProtectionRule: { id: 'id-of-unlocked-3', lockBranch: false, pattern: 'unlocked' }
                }
            }
        },
        {
...
async function runAction() {
    const action = new UnlockBranch_1.UnlockBranch();
...
describe('UnlockBranch', () => {
    ...
    it('Unlock already unlocked branch (no-op)', async () => {
        process.env['INPUT_BRANCH-PATTERN'] = 'unlocked';
        await runAction();
        expect(logTester.logsParams).toStrictEqual([
            "Invoked sendGraphQL list branch protection rules",
            "Invoked sendGraphQL updateBranchProtectionRule to unlock id-of-unlocked-3",
            "Done: test-repo: The branch `unlocked` was unlocked and is now open for changes :sunny:",
...
//# sourceMappingURL=UnlockBranch.test.js.map